        ...
        <Row>
          ...
          <Col style={{ height: "fit-content"}}>
            <Row style={{ display: "flex", flexDirection: "column", height: "100vh" }}>
              ...
              <RecordBar quote={this.state.character.quote[this.state.selectedQuote]} selectedCharacter={this.state.selectedCharacter} selectedQuote={this.state.selectedQuote} phrase1={this.state.character.quote}/>
            </Row>
          </Col>
        </Row>
      </Container>
